...
import { memo, useEffect, useSyncExternalStore, useCallback, useMemo } from "react";
...
function darkSubscribe(callback: () => void) {
...
export const AppSidebar = memo(function AppSidebar({
  ...
  const navLinks = useMemo(
    ...
    [pathname, notificationCounts, collapsed, onMobileClose]
  );
